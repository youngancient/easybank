...
const articleData = [
  { id: 1, alt: 'currency' , author: 'By Claire Robinson',  imgSrc: '/assets/image-confetti.jpg', heading : 'Receive money in any currency with no fees ', text: 'The world is getting smaller and we’re becoming more mobile. So why should you be forced to only receive money in a single …'},
...
const Main = () => {
  ...
  return (
    <main className="">
      ...
      <motion.section className="s-reasons"
      variants={heroVariants}
      initial='initial'
      animate= 'section'
      >
